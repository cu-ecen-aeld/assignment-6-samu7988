...
# SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-samu7988.git;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# TODO: set to reference a specific commit hash in your assignment repo
#SRCREV = "0dbe08272d48a2a49611374a04ae2b3b5efecc77"
...
do_install () {
	...
	#install destination directory /usr/bin
	install -d ${D}${bindir}

	#install aesdsocket utility to /usr/bin
	install -m 0755 ${S}/aesdsocket ${D}${bindir}/

	#install destination directory for init script
	install -d ${D}${sysconfdir}/init.d

	#install aesdsocketstart-stop script in this location
